    ...
    <div style={S.root}>
      <div style={S.container}>
        ...
        <div style={{ marginBottom: "1.5rem" }}>
          ...
          <p style={{ fontSize: 14, color: "#9B9991", margin: 0 }}>Log in para ma-access ang estimator at 2307 tracker mo.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={S.card}>
          ...
          <label style={{ display: "block", fontSize: 12, color: "#9B9991", marginBottom: 6 }}>Password</label>
          <input
            type="password"
          ...
          <p style={{ textAlign: "center", marginTop: 16, marginBottom: 0, fontSize: 14, color: "#6B6B66" }}>
            Wala pang account?{" "}
            <Link to="/register" style={{ color: "#0B3D2C", fontWeight: 600 }}>
              Mag-register
            </Link>
          </p>
        </form>
